...
public class IncomeCalculator {
	...
	public static void main(String[] args) {
		...
		// Outer while loop to run again if needed. Question
		// at the end of code.
		...
		while (restartProgram == 1) {
			...
			if (ServRes == 2) {
				ServResCon = 0;
				rentAssist = Double.parseDouble(
						gt.getInputString("How much rental assistance do you recieve per pay (fornight)?"));
			...
			if (ynBeforeTaxDeductions == 1) {
				BeforeTaxDeductions = Double.parseDouble(
						gt.getInputString("What is the total before tax deductions listed on your payslip?"));
